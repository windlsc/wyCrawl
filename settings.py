...
# Scrapy settings for eastMoneyCrawl project
#
...
SPIDER_MODULES = ['wyCrawl.spiders']
NEWSPIDER_MODULE = 'wyCrawl.spiders'


# Crawl responsibly by identifying yourself (and your website) on the user-agent
#USER_AGENT = 'eastMoneyCrawl (+http://www.yourdomain.com)'
...
USER_AGENTS = [
    ...
    'Mozilla/4.0 (compatible; MSIE 7.0; Windows NT 6.0; AcooBrowser; SLCC1; .NET CLR 2.0.50727; Media Center PC 5.0; .NET CLR 3.0.04506)',	
